...
// WAITLIST (DEPRECATED - Legacy system, kept for backwards compatibility)
// New signups should use direct invite system instead
export const waitlist = {
  add: async (email, inviteCode) => {
    console.warn('waitlist.add is deprecated. Use invite system instead.');
    const { data, error } = await supabase
      .from('waitlist')
      .insert({ 
