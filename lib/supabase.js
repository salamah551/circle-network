...
// Import browser singleton to prevent multiple GoTrueClient instances
// This is a dynamic import to avoid issues during SSR
...
function getSupabaseClient() {
  ...
  if (typeof window !== 'undefined') {
    if (!browserClientModule) {
      // Dynamic import to get the browser singleton
