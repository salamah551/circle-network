...
export function isFeatureUnlocked(featureName) {
  ...
  const alwaysAvailable = [
    ...
    'help',
    'notifications_view',
    'strategic_intros' // ADD THIS - makes strategic intros always available
  ];
...
export const FEATURES = {
  ...
  expert_sessions: {
    ...
    description: 'Book 1-on-1 time with network experts',
    value: 'Get personalized guidance from industry leaders through bookable consultation sessions',
    icon: 'GraduationCap'
  },
  value_exchange: {
