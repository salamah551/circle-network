  ...
  return (
    <div className="min-h-screen bg-black text-white py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          {isFoundingMember && (
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-amber-500/10 border border-amber-500/20 rounded-full mb-4">
              ...
              <span className="text-amber-400 font-semibold">Inner Circle (Founding Member)</span>
            </div>
          )}
          {isCoreMember && (
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-purple-500/10 border border-purple-500/20 rounded-full mb-4">
              <Sparkles className="w-5 h-5 text-purple-400" />
              <span className="text-purple-400 font-semibold">Core (Charter Member)</span>
            </div>
          )}
        ...
        {/* Founding/Inner Circle Member Benefits */}
        {isFoundingMember && (
          <div className="bg-gradient-to-br from-amber-500/10 to-transparent border border-amber-500/20 rounded-xl p-8 mb-8">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-zinc-400">Exclusive, high-touch advantages with full ARC™ access</p>
              </div>
            </div>

            <div className="grid md:grid-cols-2 gap-4">
              {[
                'Full ARC™ AI access - unlimited intelligence',
          ...
          <div className="bg-gradient-to-br from-purple-500/10 to-transparent border border-purple-500/20 rounded-xl p-8 mb-8">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-zinc-400">Immediate access with limited ARC™ capabilities</p>
              </div>
            </div>
