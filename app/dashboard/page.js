      ...
      <main className="lg:ml-64 min-h-screen">
        <div className="max-w-7xl mx-auto p-4 md:p-6 lg:p-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            <Link
              href="/intros"
              className="group bg-gradient-to-br from-amber-500/10 via-zinc-900 to-zinc-950 rounded-xl p-6 border border-amber-500/20 hover:border-amber-500/40 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:ring-offset-2 focus:ring-offset-black"
            >
              <div className="flex items-start justify-between mb-4">
                <div className="w-12 h-12 bg-amber-500/20 rounded-lg flex items-center justify-center">
                  <Sparkles className="w-6 h-6 text-amber-400" />
                </div>
                <ChevronRight className="w-5 h-5 text-zinc-600 group-hover:text-amber-400 group-hover:translate-x-1 transition-all duration-300" />
              </div>
            ...
            <Link
              href="/members"
              className="group bg-gradient-to-br from-emerald-500/10 via-zinc-900 to-zinc-950 rounded-xl p-6 border border-emerald-500/20 hover:border-emerald-500/40 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:ring-offset-2 focus:ring-offset-black"
            >
              <div className="flex items-start justify-between mb-4">
                <div className="w-12 h-12 bg-emerald-500/20 rounded-lg flex items-center justify-center">
                  <Users className="w-6 h-6 text-emerald-400" />
                </div>
                <ChevronRight className="w-5 h-5 text-zinc-600 group-hover:text-emerald-400 group-hover:translate-x-1 transition-all duration-300" />
              </div>
            ...
            <Link
              href="/messages"
              className="group bg-gradient-to-br from-blue-500/10 via-zinc-900 to-zinc-950 rounded-xl p-6 border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:ring-offset-2 focus:ring-offset-black"
            >
              <div className="flex items-start justify-between mb-4">
                <div className="w-12 h-12 bg-blue-500/20 rounded-lg flex items-center justify-center">
                  <MessageSquare className="w-6 h-6 text-blue-400" />
                </div>
                <ChevronRight className="w-5 h-5 text-zinc-600 group-hover:text-blue-400 group-hover:translate-x-1 transition-all duration-300" />
              </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              {!canAccessEliteFeatures && (
                <Link
                  href="/#pricing"
                  className="px-4 py-2 bg-purple-500/20 hover:bg-purple-500/30 border border-purple-500/50 text-purple-400 rounded-lg transition-all duration-300 text-sm font-semibold flex items-center gap-2 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:ring-offset-2 focus:ring-offset-black"
                >
                  <Crown className="w-4 h-4" />
                  Upgrade to Elite
                </Link>
...
function LockedFeatureCard({ icon: Icon, title, description, status, launchDate, href, isFoundingMember, isPremiumMember }) {
    ...
    return (
      <div className="relative bg-gradient-to-br from-emerald-500/5 via-zinc-900 to-black rounded-xl p-6 border border-emerald-500/20">
        ...
        {title.includes('Deal Flow') && (
          <div className="space-y-2 mb-4">
            ...
            {maskedOpportunities.map((opp, i) => (
              <div key={i} className="bg-zinc-900/80 border border-zinc-800 rounded-xl p-3 backdrop-blur-sm">
        ...
        <div className="bg-gradient-to-br from-purple-500/10 to-purple-600/5 border border-purple-500/30 rounded-xl p-4">
          ...
          <Link
            href="/#pricing"
            className="inline-flex items-center gap-2 px-4 py-2 bg-purple-500 hover:bg-purple-600 text-white rounded-lg transition-all duration-300 text-sm font-semibold w-full justify-center focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-zinc-900"
          >
      ...
      <div className="relative bg-gradient-to-br from-zinc-900 to-black rounded-xl p-6 border border-zinc-800 opacity-75">
        ...
        <div className="space-y-3">
          ...
          <div className="pt-3 border-t border-zinc-800">
            ...
            <Link
              href="/#pricing"
              className="inline-flex items-center gap-2 px-4 py-2 bg-purple-500/20 hover:bg-purple-500/30 border border-purple-500/30 text-purple-400 rounded-lg transition-all duration-300 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:ring-offset-2 focus:ring-offset-black"
            >
              <Crown className="w-4 h-4" />
              Upgrade to Elite
              <ArrowRight className="w-4 h-4" />
  ...
  if (isComingSoon) {
    return (
      <Link
        href={href}
        className="group relative bg-gradient-to-br from-purple-500/10 via-zinc-900 to-black rounded-xl p-6 border border-purple-500/30 hover:border-purple-500/50 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:ring-offset-2 focus:ring-offset-black"
      >
        <div className="absolute top-4 right-4">
          <ChevronRight className="w-5 h-5 text-zinc-600 group-hover:text-purple-400 group-hover:translate-x-1 transition-all duration-300" />
        </div>
