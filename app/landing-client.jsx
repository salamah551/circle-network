...
function Countdown() {
  ...
  const sec = s % 60;
  return <span className="font-mono text-sm text-white/70">{d}d {h}h {m}m {sec}s</span>;
}
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 pt-16 pb-12">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link href="/apply" className="inline-flex items-center gap-2 rounded-xl bg-amber-500 text-black font-medium px-5 py-3 hover:bg-amber-400">
              Request Access <ArrowRight className="w-4 h-4" />
            </Link>
            <Link href="/billing" className="inline-flex items-center gap-2 rounded-xl bg-zinc-900 border border-white/10 px-5 py-3 hover:bg-zinc-800">
              Founding pricing
            </Link>
          </div>
          ...
          <div className="mt-6 flex flex-wrap items-center gap-6 text-sm text-white/70">
            <div className="inline-flex items-center gap-2">
              <Shield className="w-4 h-4 text-amber-400" /> No ads. No data resale.
            </div>
            <div className="inline-flex items-center gap-2">
              <Users className="w-4 h-4 text-amber-400" /> Curated membership
            </div>
            <div className="inline-flex items-center gap-2">
              <Handshake className="w-4 h-4 text-amber-400" /> Mutual-opt-in intros
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-3 gap-6">
          <div className="rounded-2xl border border-white/10 bg-zinc-950 p-6">
            ...
            <p className="mt-2 text-white/70">Exactly 3 high-value introductions per week—AI-assisted, human-approved. Meet the right people at the right moment.</p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-zinc-950 p-6">
            <Sparkles className="w-6 h-6 text-amber-400" />
            <h3 className="mt-3 text-xl font-semibold">Impact Score & Value Exchange</h3>
            <p className="mt-2 text-white/70">Earn reputation through contribution. Exchange expertise via asks/offers. Quality rises; noise disappears.</p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-zinc-950 p-6">
      ...
      <section className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-zinc-950 to-black p-6">
            ...
            <p className="mt-2 text-white/70">Intent-based matching that prioritizes mutual value, stage fit, and adjacency—delivered as weekly, actionable opportunities.</p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-zinc-950 to-black p-6">
      ...
      <section className="max-w-6xl mx-auto px-6 py-12">
        ...
        <p className="text-white/70 mb-6">Membership is curated for high-signal operators, founders, and investors. Self-attested credentials are reviewed by our team to preserve quality.</p>
        <div className="grid md:grid-cols-3 gap-6">
          <div className="rounded-2xl border border-white/10 bg-zinc-950 p-6">
        ...
        <p className="text-white/60 text-sm mt-4">We do not guarantee admission. Applications are evaluated on fit, intent, and contribution potential.</p>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="rounded-2xl border border-white/10 bg-zinc-950 p-6">
            ...
            <p className="text-white/60 text-xs mt-3">Add-ons are optional and billed separately to preserve alignment and exclusivity.</p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="rounded-2xl border border-white/10 bg-zinc-950 p-6">
            ...
            <p className="text-white/70 text-sm mt-2">Early members lock in founding rates for as long as their subscription remains active.</p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-zinc-950 p-6">
            <h3 className="font-semibold">Capped cohort</h3>
            <p className="text-white/70 text-sm mt-2">Limited seats to preserve quality. Once the founding cohort is full, applications move to a waitlist.</p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-zinc-950 p-6">
            <h3 className="font-semibold">Early access</h3>
            <p className="text-white/70 text-sm mt-2">Priority access to new features and member-only intelligence services as they roll out.</p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-12">
        ...
        <p className="text-white/60 text-xs mt-4">We do not guarantee business outcomes, investment performance, or specific introductions. See our Terms, Privacy, and Disclaimers.</p>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="rounded-2xl border border-amber-500/30 bg-zinc-950 p-6">
            ...
            <Link href="/apply" className="mt-6 inline-flex items-center gap-2 rounded-xl bg-amber-500 text-black font-medium px-5 py-3 hover:bg-amber-400">
              Apply now <ArrowRight className="w-4 h-4" />
            </Link>
            <p className="text-white/60 text-xs mt-3">Founding price locks while active. Limited seats to preserve quality.</p>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-zinc-950 p-6">
            ...
            <Link href="/apply" className="mt-6 inline-flex items-center gap-2 rounded-xl bg-zinc-900 border border-white/10 px-5 py-3 hover:bg-zinc-800">
              Request access
            </Link>
          </div>
        ...
        <p className="text-white/60 text-sm mt-4">Add-on intelligence services are optional and billed separately. Cancel anytime in the Billing Portal.</p>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="rounded-2xl border border-white/10 bg-zinc-950 p-6">
            ...
            <p className="text-white/70 text-sm mt-2">No. We optimize for fit and momentum, but outcomes depend on your goals and engagement.</p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-zinc-950 p-6">
          ...
          <div className="rounded-2xl border border-white/10 bg-zinc-950 p-6">
            ...
            <p className="text-white/70 text-sm mt-2">Our team evaluates fit, intent, and contribution potential to preserve a high-signal community.</p>
          </div>
        </div>
      </section>
