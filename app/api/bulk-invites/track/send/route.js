...
export async function POST(request) {
  try {
    ...
    // Use standard member email sequence (founding phase system has been retired)
    const useFoundingSequence = false;
    
    console.log(`📧 Using STANDARD member email sequence`);
